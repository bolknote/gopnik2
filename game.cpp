                 ...
                 )
{
  ...
  pl [pl_index].members [plm_index].buy_phrase [pl [pl_index].members [plm_index].buy_phrase_amount]
    = strdup (buy_phrase);
...
//    buf [0] = 19;
    ...
    while ((tmp>=user_name)&&((*tmp==10)||(*tmp==0))) {*tmp=0; tmp--;}
